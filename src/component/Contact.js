       ...
       <div class="container">
           ...
           <div class="row">
             <div class="col-sm-12 col-md-6 col-lg-4 my-5">
               <div class="card border-0">
                  <div class="card-body text-center">
                    <i class="fa fa-mobile-screen-button fa-5x mb-3" aria-hidden="true"></i>
             ...
             <div class="col-sm-12 col-md-6 col-lg-4 my-5">
               <div class="card border-0">
                  <div class="card-body text-center">
                    <i class="fa fa-envelopes-bulk fa-5x mb-3" aria-hidden="true"></i>
